    ...
    <div class=" shadow pt-5 pb-5 m-5 bg-light rounded" style="width: 80%;">
        <form class="reviewform" method="post" action="main" style="width: 80%; margin: auto;">
            ...
            <div class="mb-3">
                ...
                <input  name="title" type="text" class="form-control" id="inputEmail3" name="title" placeholder="제목을 입력하세요">
            </div>

            <div class="mb-4">
                <label for="inputContent" class="col-form-label">내용</label>
                <textarea name="content" class="form-control" rows="3" name="content" placeholder="내용을 입력하세요"></textarea>
            </div>
